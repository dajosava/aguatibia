...
function RootLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950">
      <nav
        id="app-site-header"
        className="sticky top-0 z-40 shrink-0 m-0 mb-0 bg-white shadow-md border-b-2 border-blue-100 dark:bg-slate-900 dark:border-slate-700 dark:shadow-slate-950/50"
      >
      ...
      <main
        className={
          isAdminRoute
            ? 'flex-1 flex flex-col min-h-0 m-0 w-full p-0 flow-root'
            : 'flex-1 py-8'
        }
      >
        <Outlet />
